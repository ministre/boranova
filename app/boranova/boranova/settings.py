"""
Django settings for boranova project.
...
WSGI_APPLICATION = 'boranova.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        "NAME": os.environ.get("SQL_DATABASE", default="boranova"),
